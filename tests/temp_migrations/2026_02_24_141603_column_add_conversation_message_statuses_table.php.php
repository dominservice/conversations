...
return new class extends Migration {
    ...
    public function up()
    {
         if (Schema::hasTable(config('conversations.tables.conversation_message_statuses'))
                   && !Schema::hasColumn(config('conversations.tables.conversation_message_statuses'), 'notified_at')
               ) {
               ...
               if (Schema::hasTable(config('conversations.tables.conversations'))
                   && !Schema::hasColumn(config('conversations.tables.conversations'), 'read_only')
               ) {
